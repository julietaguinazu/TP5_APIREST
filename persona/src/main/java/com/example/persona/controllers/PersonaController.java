...
public class PersonaController {
    ...
    public PersonaController(PersonaService personaSeervice){
    ...
    @PutMapping("/{id}")
    public ResponseEntity<?> update(@PathVariable Long id,@org.springframework.web.bind.annotation.RequestBody Persona entity){
        try {
